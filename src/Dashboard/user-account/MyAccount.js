...
import { BASE_URL, USER_IMG_PATH } from '../../config';
          ...
          <div className="pb-[50px] px-[30px] rounded-md">
            <div className="flex items-center justify-center">
              <figure className="w-[100px] h-[100px] rounded-full border-2 border-solid border-primaryColor">
                <img src={`${ USER_IMG_PATH}/${data.photo}`} alt="" className="w-full h-full rounded-full" />
              </figure>
            </div>
            ...
            <div className="mt-[50px] md:mt-[100px]">
              <button onClick={handleLogout} className="w-full bg-[#181A1E] p-3 leading-7 text-[16px] rounded-md text-white">Logout</button>
              <button className="w-full bg-red-600 mt-4 p-3 leading-7 text-[16px] rounded-md  text-white">Delete account</button>
            </div>
          </div>
