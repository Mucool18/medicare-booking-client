          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <h3 className="text-headingColor text-[22px] leading-9 mt-3 font-bold ">Aakash Sharma</h3>
                <div className="flex items-center gap-[6px] ">
                  <span className="flex items-center gap-[6px] text-[16px] leading-5 text-[16px] lg:leading-7 font-semibold text-headingColor ">
